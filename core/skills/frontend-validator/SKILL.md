...
type: skill
applies_to: |
  Carregada por jdi-reviewer-{slug} no gate 7 quando `frontend.has_frontend: true` em .jdi/PROJECT.md.
  Pode ser invocada manualmente pra validacao UI ad-hoc.
loaded_by:
  - jdi-reviewer-{slug} (condicional)
runtime_overrides:
  antigravity:
    triggers:
      - "validar UI"
